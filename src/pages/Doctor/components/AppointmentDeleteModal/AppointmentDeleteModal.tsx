      ...
      >
        ...
        <div className='p-6'>
          ...
          <p className='text-center text-sm text-gray-600'>
            Appointment for <span className='font-semibold'>{appointment.petName}</span> ({appointment.customerName}) on{' '}
            <span className='font-semibold'>{new Date(appointment.appointmentTime).toLocaleString('vi-VN')}</span>
          </p>
