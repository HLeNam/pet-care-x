...
const Footer = () => {
  ...
  return (
    <footer className='mx-2 mt-12 rounded-lg bg-gray-900 text-gray-300'>
        ...
        <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-5'>
          ...
          <div className='sm:col-span-2 lg:col-span-2'>
            ...
            <p className='mt-4 max-w-md text-sm leading-relaxed text-gray-400'>
              PetCareX is an all-in-one pet care platform that helps pet owners schedule veterinary appointments, manage
              pet medical records, and purchase pet products and medicines online.
            </p>
          </div>
